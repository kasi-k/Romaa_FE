const COLORS = {
  ...
  IN_STORE: "bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300",
  ISSUED: "bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-300",
  UNDER_REPAIR: "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-300",
  LOST: "bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300",
  SCRAPPED: "bg-gray-200 text-gray-600 dark:bg-gray-800 dark:text-gray-400",
  PARTIALLY_RETURNED: "bg-teal-100 text-teal-700 dark:bg-teal-900/30 dark:text-teal-300",
  ...
  ADJUSTED: "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-300",
  OUT_OF_TOLERANCE: "bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-300",
...
const StatusChip = ({ value, className = "" }) => {
  if (!value) return null;
  const cls = COLORS[value] || "bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300";
  return (
    <span
      className={`inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wide ${cls} ${className}`}
    >
